...
De los problemas anteriores considero que ya quedaron solucionados, solo faltaría el terminar de conectar mi base de datos para consumir el contenido de cartoons desde ahí mismo.
